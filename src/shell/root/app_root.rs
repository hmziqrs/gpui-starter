...
use crate::views::{
    ...
    QueryPlaygroundPage, ReloadCurrentPage, RenderErrorPage, SettingsPage, TriggerRenderError,
};
use crate::{
    app::ToggleSearch,
...
use super::actions::{NavigateToPage, RefreshPage, is_rtl_locale};
use super::frame_time::{self, is_slow_frame};
