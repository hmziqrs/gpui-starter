...
If you want to explore GPUI, the [getting started guide](/docs/getting-started/) walks through setting up a project from scratch. For a deeper look at how GPUI apps are structured, the [architecture overview](/docs/architecture/) covers the core concepts. The [gpui-starter repository](https://github.com/freeoxide/gpui-starter) provides a production-ready boilerplate with navigation, theming, i18n, SQLite persistence, and auto-updating, so you can skip the scaffolding and start building.
