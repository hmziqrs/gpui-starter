...
If you want to see these patterns in a working app, [gpui-starter](https://github.com/freeoxide/gpui-starter) provides a production-ready boilerplate with multi-page navigation, theme support, SQLite persistence, and all the scaffolding you need to start building. The [getting started guide](/docs/getting-started/) walks through setting up your first project in a few minutes.
