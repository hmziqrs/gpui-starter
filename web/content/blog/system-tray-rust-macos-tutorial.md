...
If you want to see all of this wired together, check out [gpui-starter](https://github.com/hmziqrs/gpui-boilerplate). It ships a working tray icon with programmatic glyph generation, click handling wired through GPUI's async runtime, and the context menu you'd expect from a production macOS app. The [getting started guide](/docs/getting-started/) walks through the full setup.
